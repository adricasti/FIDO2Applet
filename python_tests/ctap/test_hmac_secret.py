...
class HMACSecretTestCase(CTAPTestCase):
    ...
    def test_hmac_and_credblob_together(self):
        ...
        auth_exts = hmac_alone_assertion.get_response(0).response.authenticator_data.extensions
        self.assertTrue(auth_exts is None or "credBlob" not in auth_exts)
        ...
        auth_exts2 = assertion.get_response(0).response.authenticator_data.extensions
        self.assertIsNotNone(auth_exts2, "credBlob expected in authenticator extensions")
